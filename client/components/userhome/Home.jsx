                ...
                <div className="col-md-9">
                    <div className="panel panel-default">
                        ...
                        <div className="panel-body">
                            ...
                            <hr/>
                            <button onClick={this.askFriend} className="btn btn-lg btn-success space">Ajouter en ami</button>
                            <button onClick={this.showSendMessage}  type="button" className="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Laisser un message</button>
                        </div>
